...
RUN curl -L -o /root/Rocky-8.1.1911-x86_64-boot.iso http://isoredirect.rockylinux.org/rocky/8/isos/x86_64/Rocky-8.1.1911-x86_64-boot.iso
RUN echo $(sha256sum /root/Rocky-8.1.1911-x86_64-boot.iso)
